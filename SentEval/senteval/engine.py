...
from senteval.ptbr_sts import PtBrSTSEval
...
class SE(object):
    def __init__(self, params, batcher, prepare=None):
        ...
        self.list_tasks = ['CR', 'MR', 'MPQA', 'SUBJ', 'SST2', 'SST5', 'TREC', 'MRPC',
                           ...
                           'OddManOut', 'CoordinationInversion', 'SICKRelatedness-finetune',
                           'STSBenchmark-finetune', 'STSBenchmark-fix','PtBrSTS']
    ...
    def eval(self, name):
        ...
        # CUSTOM TASK
            ...
            self.evaluation = PtBrSTSEval(tpath, seed=self.params.seed)
        # Probing Tasks
        elif name == 'Length':
